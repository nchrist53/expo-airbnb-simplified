...
export default function HomeScreen() {
    ...
    const handleShowFavorites = (id) => {
        return favorites.some((favorite) => favorite.id === id) ? "heart" : "heart-o";
    };
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View>
                        ...
                        >
                            <FontAwesome name={handleShowFavorites(item.id)} size={24} color="#ff5a5f" />
                        </Pressable>
                        <Pressable
                            onPress={() => {
                            router.push({
